...
**Files:**
- Modify: `src/components/VirtualList.tsx` (replace with `@tanstack/react-virtual` or custom measure)
...
describe('time utils', () => {
  ...
  it('formatRelativeTime shows minutes for < 1 hour', () => {
    ...
    expect(formatRelativeTime(d)).toMatch(/5 min/)
  })
})
```
...
Plan complete and saved to `docs/superpowers/plans/2026-07-10-comprehensive-fixes-improvements.md`.
